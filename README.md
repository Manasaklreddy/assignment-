These screenshots demonstrate user authentication for two distinct roles: Faculty and Students. The system features secure registration and login processes using JWT-based role-based access control.
